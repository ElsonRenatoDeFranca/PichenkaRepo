 ...
 * 2018-01-01T17:37:39.245-02:00
 * Generated source version: 3.2.0
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/C:/Development/PetProjects/PichenkaRepo/SOAPWebservices_ClientDemoApp01/src/main/resources/CustomerOrders.wsdl",
...
public class CustomerOrdersService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Development/PetProjects/PichenkaRepo/SOAPWebservices_ClientDemoApp01/src/main/resources/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Development/PetProjects/PichenkaRepo/SOAPWebservices_ClientDemoApp01/src/main/resources/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
