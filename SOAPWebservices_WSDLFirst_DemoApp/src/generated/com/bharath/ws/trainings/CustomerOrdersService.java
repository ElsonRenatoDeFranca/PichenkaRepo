 ...
 * 2017-12-31T20:30:10.376-02:00
 * Generated source version: 3.2.0
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/C:/Development/PetProjects/PichenkaRepo/SOAPWebservices_WSDLFirst_DemoApp/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl",
...
public class CustomerOrdersService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Development/PetProjects/PichenkaRepo/SOAPWebservices_WSDLFirst_DemoApp/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Development/PetProjects/PichenkaRepo/SOAPWebservices_WSDLFirst_DemoApp/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
